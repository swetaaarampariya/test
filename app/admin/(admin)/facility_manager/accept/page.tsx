...
const Page = () => {
  ...
  const fetchUser = async () => {
    let params = `limit=${limit}&page=${page}&role=Facility Manager&isFacilityManagerApproved=true`;
  ...
  const Columns = useMemo<ColumnT[]>(
    () => [
      ...
      },
      {
        ...
        name: "status",
        filterable: true,
        value: () => <span className="table-span capitalize">Accept</span>,
      },
      {
        header: "Action",
        name: "action",
